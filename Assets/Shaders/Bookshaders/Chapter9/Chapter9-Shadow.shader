Shader "ShaderBook/Chapter9/Shadow"
{
    //base:Blinn Phong
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            #include "AutoLight.cginc"  //注意计算阴影所用的宏要在这里声明
            ...
            struct v2f
            {
                ...
                SHADOW_COORDS(2)  //声明一个用于对阴影纹理采样的坐标,参数2是下一个可用的插值寄存器的索引值
            };
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //SHADOW_COORDS,TRANSFER_SHADOW,SHADOW_ATTENUATION是计算阴影时的"三剑客"
            }
            ENDCG
        }
